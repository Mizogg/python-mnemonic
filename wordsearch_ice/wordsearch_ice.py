...
console.print("==========================================================")
divs = 1 #int(input(" 📋How Many Derivation Paths m/44'/0'/0'/0/0/ to m/44'/0'/0'/0/999/ ✍️ -> "))
...
def data_wallet():
    for child in range(0,divs):
        ...
        bal = xBal(bip32_child_key_obj.Address())
        bal1 = xBal1(uaddr)
        data.append({
                ...
                'wifu': wifu,
                'uaddr': uaddr,
                'BalanceCompressed':bal,
                'BalanceUncompressed':bal1,
            })
...
while True:
    ...
    for target_wallet in data:
        bal = target_wallet['BalanceCompressed']
        bal1 = target_wallet['BalanceUncompressed']
